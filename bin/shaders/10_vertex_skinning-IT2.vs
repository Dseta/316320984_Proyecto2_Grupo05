...
void main()
{
    ...
    // Sumamos absolutamente todos los pesos que podría tener el vértice
    float totalWeight = bWeights1[0] + bWeights1[1] + bWeights1[2] + bWeights1[3] +
                        bWeights2[0] + bWeights2[1] + bWeights2[2] + bWeights2[3] +
                        bWeights3[0] + bWeights3[1] + bWeights3[2] + bWeights3[3];
                        
    // Si la tarjeta gráfica detecta un vértice vacío o basura matemática
    if (totalWeight < 0.01) {
        // lo forzamos a usar su posición original sin deformar
